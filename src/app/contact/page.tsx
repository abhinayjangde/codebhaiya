...
const Contact: React.FC = () => {
    ...
    return (
        <div>
            ...
            {/* Contact Us  */}
            {/* <section className="sm:h-[50rem] text-gray-600 dark:text-white dark:bg-background body-font relative">
                            ...
                            <div className="p-2 w-1/2">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        id="name"
                                        name="name"
                                        className="w-full bg-transparent bg-opacity-50 rounded border border-gray-300 dark:focus:bg-background focus:border-indigo-500 focus:bg-white focus:ring-2 dark:text-white focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                                    />
                                </div>
                            </div>
                            <div className="p-2 w-1/2">
                            ...
                            <div className="p-2 w-full">
                                <div className="relative">
                                    ...
                                    <textarea
                                        id="message"
                                        name="message"
                                        className="w-full bg-transparent rounded border border-gray-300 focus:border-indigo-500 dark:focus:bg-background focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none dark:text-white text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                                        defaultValue={""}
                                    />
                                </div>
                            </div>
