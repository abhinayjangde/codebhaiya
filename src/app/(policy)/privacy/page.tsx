...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="dark:bg-background py-5 bg-gray-50 md:p-4">
      <div className="max-w-5xl mx-auto bg-white dark:text-white dark:bg-black/30  rounded-lg shadow-md p-6 lg:p-10">
        <h1 className="text-center text-2xl md:text-3xl justify-center lg:text-4xl font-semibold text-gray-800 dark:text-white mb-2 flex border-b pb-2">
          Privacy Policy
        </h1>
        <p className="bg-slate-200 text-center dark:bg-slate-800 mb-2 px-2 py-1 md:inline-block">
          Last updated: April 25, 2024
        </p>
        <p>
          Our Privacy Policy outlines how Code Bhaiya (We/us) handles your
          privacy while you use our website www.codebhaiya.com (Website). It
          explains our current procedures for collecting, storing, using, and
          securing your personal information on our Website. Additionally, it
          clarifies your options for accessing, correcting, and using your
          personal data, as well as the steps for addressing grievances or
          complaints. By accessing www.codebhaiya.com, you agree to comply with
          the terms and conditions set forth in this Privacy Policy. We advise
          you to carefully review this Policy, as your use of the Website
          signifies your understanding and acceptance of its terms. If you do
          not agree with the terms and conditions of this Privacy Policy, please
          refrain from accessing the Website. We are committed to periodically
          reviewing and updating this Privacy Policy. Please note that as a
          visitor, you acknowledge that this Policy may change without prior
          notice. To stay informed about any changes, we recommend reviewing
          this Policy regularly. For the purposes of this Policy, (Personal
          Data) refers to any information that can identify you directly or
          indirectly as an individual.
        </p>
