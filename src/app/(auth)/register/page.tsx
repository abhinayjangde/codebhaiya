  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-background to-muted/50 px-4 py-12">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <motion.div
          className="absolute top-1/3 right-1/4 w-64 h-64 bg-chart-2/5 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.15, 1],
            x: [0, 30, 0],
            y: [0, -20, 0],
      ...
      >
        ...
        >
          <motion.div
            className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-chart-1/10 mb-4"
            whileHover={{ scale: 1.05, rotate: -5 }}
            whileTap={{ scale: 0.95 }}
          >
            <Rocket className="w-8 h-8 text-chart-1" />
          </motion.div>
          <h1 className="text-2xl font-bold text-foreground">Join CodeBhaiya</h1>
