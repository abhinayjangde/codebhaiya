...
const Testimonial: React.FC = () => {
  return (
    <div className="h-160 flex flex-col antialiased bg-white dark:bg-background items-center justify-center overflow-hidden">
...
const testimonials = [
  ...
  {
    quote:
      "All that we see or seem is but a dream within a dream. I'm Iron Man.",
    name: "Chandani Patre",
