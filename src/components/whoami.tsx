          ...
          <div className="mx-auto flex flex-col-reverse items-center justify-center gap-10 md:w-10/12 lg:flex-row">
            <div className="flex-1 md:p-5">
              ...
              <p className="my-4 md:text-lg">
                Hi👋, I&apos;m Abhinay - a passionate Full Stack Developer,
                educator, and content creator. I thrive on the dynamic
                intersection of coding, technology, and education.
              </p>
              <p className="my-4 md:text-lg">
              ...
              <Link
                href={env.discord}
                target="_blank"
                className="flex gap-2 px-2 py-1 items-center border bg-gray-100 hover:bg-[#cdd1ff] dark:bg-[#5865F2]  dark:hover:bg-[#4a56da] w-fit rounded-md"
              >
            ...
            <div className="flex flex-[0.7] items-center justify-center md:p-5">
              <div className="flex items-center justify-center">
                <Image
                  ...
                  decoding="async"
                  data-nimg={1}
                  className="sm:w-full w-[80%] rounded-full border border-gray-400 cursor-pointer transition-all duration-300 ease-in-out hover:scale-105"
