...
const RecommendedCourses: React.FC = () => {
    return (
        <>
            <div className="sm:h-240 w-full dark:bg-background bg-white  dark:bg-grid-white/[0.1] bg-grid-black/[0.1] flex items-center justify-center">
                <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-background bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_100%,black)]">
                </div>
                {/* Recommended Courses  */}
                <div className="container mx-auto lg:my-2">
                    ...
                    <div className="flex flex-wrap justify-between">
                        <div className="py-4 md:p-4 md:w-1/3 flex justify-center">
                            <div className="max-w-sm rounded-2xl overflow-hidden shadow-lg dark:bg-black/50 bg-white/80">
                                <Image
                        ...
                        <div className="py-4 md:p-4 md:w-1/3 flex justify-center">
                            <div className="max-w-sm rounded-2xl overflow-hidden shadow-lg dark:bg-black/[0.5] bg-white/[0.8]">
                                <Image
                                    className="object-contain w-full object-center"
                                    src="https://i.ytimg.com/vi/g8j2mlygJMc/hq720.jpg?sqp=-oaymwEnCNAFEJQDSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLBwCxdZRvXIspa1i2ogT9XCei5wUQ"
                                    width={384}
                                    height={216}
                                    alt="Image"
                                />
